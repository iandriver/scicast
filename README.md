...
![example k-means cluster map](krasnow_scicast_example_output/scicast_analysis/Group0_kmeans_4_clusters.png)

Heatmap for k-means assignment:
![example k-means cluster map](krasnow_scicast_example_output/scicast_analysis/kmeans_label_with_4_clusters_heatmap.png)

Gene Correlation search:
![example Sftpa correlation group](krasnow_scicast_example_output/scicast_analysis/All_cells_corr_with_Sftpa1.png)
